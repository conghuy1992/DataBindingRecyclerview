package example.conghuy.com.databindinginrecyclerview;
...
import example.conghuy.com.databindinginrecyclerview.databinding.PostRowItemBinding;
...
public class PostsAdapter extends RecyclerView.Adapter<PostsAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void handler(final Post post, int index) {
...
//        });
        ...
        holder.handler(postList.get(position), position);
    }
